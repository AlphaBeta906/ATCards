...
try:
    ...
    sys.exit()
print ("ATCards [Version 1.6.17.14]")
...
rare = ["Republic of Castile", "Kingdom of Leon", "Belastan", "DigitalNewia", "Republic of Castile", "Googleplus Republic", "Saxony Kingdom", "Anti-OK Alliance", "Gyrwhen Republic", "Russian Kingdoms"]
